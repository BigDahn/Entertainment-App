...
function SeriesDetails() {
  ...
  return (
    <main className="px-4  max-w-full m-auto py-3    grid gap-2">
      ...
      <main key={id}>
        <div className="flex flex-col gap-1.5  justify-items-start max-w-[100%] h-[100%] ">
          <div>
          ...
          <section className="flex gap-3 justify-between max-w-[100%] items-start h-fit pt-1 ">
            <div className=" flex flex-col gap-2  max-w-[650px] order-last">
              <h3 className="text-[15px] max-w-[100%] leading-[25px] tracking-wide">
                {description}
              </h3>
              <div
                className={`${
            ...
            <div>
              <img
                src={poster}
                className="  object-contain h-fit  max-w-[100%] "
              />
            </div>
          </section>
        </div>
